		...
		while (devamEt) {
			...
			if (secim == 1) {
				...
				for (Gorev gorev : gorevService.hepsiniGetir()) {
					System.out.println(gorev.getId() + " " + gorev.toString());
				
				}
				int secim3 = Integer.parseInt(scanner.nextLine());
				System.out.println("Silinen Görev:" + " " + gorevService.gorevGetir(secim3));
				gorevService.gorevSil(secim3);
				...
				Gorev secilenGorev = gorevService.gorevGetir(secim2);
				System.out.println();
				...
				String gorevAciklamasi = scanner.nextLine();
				System.out.println("Görev:" + " " + gorevAdi + " " + gorevAciklamasi + " " + "olarak deðiþtirildi.");
				gorevService.gorevGüncelle(secilenGorev.getId(), gorevAdi, gorevAciklamasi);
				...
				System.out.println("Yapýlan Görev:" + " " + gorevService.gorevGetir(secim4));
				gorevService.gorevTamamla(secim4);
